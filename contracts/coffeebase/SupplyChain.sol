    ...
    ConsumerRole
{
    ...
    modifier verifyCaller(address _address) {
        require(msg.sender == _address, "The sender must be the caller");
        _;
    }
    ...
    modifier paidEnough(uint256 _price) {
        require(
            msg.value >= _price,
            "The paid amount is not sufficient to cover the price"
        );
        _;
    }
    ...
    modifier harvested(uint256 _upc) {
        require(
            ...
            "The corresponding item is not Harvested yet"
        );
        _;
    }
    ...
    modifier processed(uint256 _upc) {
        require(
            ...
            "The corresponding item is not Processed yet"
        );
        _;
    }
    ...
    modifier packed(uint256 _upc) {
        require(
            ...
            "The corresponding item is not Packed yet"
        );
        _;
    }
    ...
    modifier forSale(uint256 _upc) {
        require(
            ...
            "The corresponding item is not ForSale yet"
        );
        _;
    }
    ...
    modifier sold(uint256 _upc) {
        require(
            ...
            "The corresponding item is not Sold yet"
        );
        _;
    }
    ...
    modifier shipped(uint256 _upc) {
        require(
            ...
            "The corresponding item is not Shipped yet"
        );
        _;
    }
    ...
    modifier received(uint256 _upc) {
        require(
            ...
            "The corresponding item is not Received yet"
        );
        _;
    }
    ...
    modifier purchased(uint256 _upc) {
        require(
            items[_upc].itemState == State.Processed,
            "The corresponding item is not Purchased yet"
        );
        _;
    }
